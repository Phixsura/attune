...
export const auditLogPageTestables = {
  areFiltersEqual,
  ...
  describeLocalAuditMatch,
  draftToFilters,
  emptyToUndefined,
  filtersToDraft,
  findBurstContextForEntry,
  ...
  groupEntriesByDay,
  hasActorFilter,
  hasSingleActionFilter,
  hasTargetFilter,
  isCommandSurfaceTarget,
  isEqualValue,
  isPlainObject,
  isTextEntryTarget,
  isoToLocalDateTimeInput,
  localDateTimeToISO,
  matchesLocalAuditQuery,
  normalizeArray,
  readAuditLogStateFromUrl,
  savedViewMatchesCurrent,
  savedViewStateSignature,
  savedViewStateToFilters,
  savedViewToAuditUrlState,
  safeParseJson,
