...
export enum ErrorCode {
  ...
  PROMPT_OUTPUT_LANGUAGE_POLICY_INVALID = "PROMPT_OUTPUT_LANGUAGE_POLICY_INVALID",
  PROMPT_TITLE_MAX_CHARS_INVALID = "PROMPT_TITLE_MAX_CHARS_INVALID",
  PROMPT_RATIONALE_MAX_CHARS_INVALID = "PROMPT_RATIONALE_MAX_CHARS_INVALID",
  PROMPT_TONE_INVALID = "PROMPT_TONE_INVALID",
  PROMPT_DOMAIN_GUIDANCE_TOO_LONG = "PROMPT_DOMAIN_GUIDANCE_TOO_LONG",
