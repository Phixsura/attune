-- Migration 061: idempotently converge prompt-policy version storage.
--
-- This keeps fresh, upgraded, and partially migrated databases on the same
-- prompt-policy schema and active-version baseline.
