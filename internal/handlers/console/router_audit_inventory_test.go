...
func workflowMutatingRouteCoverage() map[string]string {
	return map[string]string{
		...
		"PATCH /inbound/sources/{id}":                        "audited: inbound_source.update",
...
func surveyMutatingRouteCoverage() map[string]string {
	return map[string]string{
		...
		"POST /surveys/campaigns/{campaign_id}:scheduleNpsRun":                     "audited: survey.nps_run_schedule",
		"POST /surveys/campaigns/{campaign_id}/nps-runs/{run_id}:cancel":           "audited: survey.nps_run_cancel",
		"POST /surveys/campaigns/{campaign_id}/nps-runs/{run_id}/evidence-exports": "audited: survey.nps_run_evidence_export",
