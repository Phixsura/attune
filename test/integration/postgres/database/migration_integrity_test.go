...
func TestMigrations_MigrationCount(t *testing.T) {
	...
	require.Equal(t, 82, count, "should have 82 migrations")
...
func TestMigrations_LoadMigrationNames_All(t *testing.T) {
	...
	// Should have 82 migrations
	require.Len(t, names, 82)

	// First and last
	require.Equal(t, "001_init.sql", names[0])
	require.Equal(t, "082_audit_evidence_export.sql", names[len(names)-1])
